...
function changeGoods_sort(data) {
    /*
...
function changGoods_percentage(data) {
    /*
    {goods:[
     {"title":"商品1","inventory":200},
     {"title":"商品2","inventory":50},
     {"title":"商品3","inventory":196},
     {"title":"商品4","inventory":154},
     {"title":"商品5","inventory":296},
    ],
    sum:2000
    }
    */
    ...
    for(;i < data.goods.length;i ++){
        ...
        value[i] = {value:data.goods[i].inventory,name:data.goods[i].title};
        sum += data.goods[i].inventory;
    }
    legend[i] = "其他";
    value[i] = {value:data.sum - sum,name:"其他"};
    goods_percentage.setOption(goods_percentage_option);
}
changInventory_warring({goods:[{"title":"测试商品1","inventory":20},
    {"title":"测试商品2","inventory":66},
    {"title":"测试商品3","inventory":85},
    {"title":"测试商品4","inventory":46},
    {"title":"测试商品5","inventory":29}]
})
changeGoods_sort({goods:[{"title":"测试商品1","soldNumber":1800,"inventory":500},
    {"title":"测试商品2","soldNumber":1500,"inventory":200},
